...
* Для удобства давайте здесь использовать только sitelen Lasina. [Урок про имена](/ru/07/) показывает всё, что нужно для *sitelen pona*!
...
Most people want to adapt a name they already use. Often, it's a first name. For example, [jan Tepan](https://github.com/stefichjo/toki-pona)'s first name is Stephan. Sometimes, it's a first name + last name. [jan Misali](https://www.youtube.com/@HBMmaster/)'s name is Mitch Halley.
...
You might know the Vietnamese surname Nguyen, pronounced <Audio from="ipa" file="ˈhɛðə" />. But in English, these sounds can't go in that order. So when English speakers say Nguyen, they adapt it to what English allows -- "win".
