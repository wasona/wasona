...
**&#xF19A6; su** refers to the [third book](../jan-sonja) by jan Sonja after **󱤪󱥕 lipu pu** and **󱤪󱦈 lipu ku**. It was published in 2023. Our polling says fewer people use the word **&#xF19A6; su** than the words **󱥕 pu** and **󱦈 ku**. Why is that? The exact cause-and-effect is hard to trace, but here are some observations:
...
**wuwojiti** is a mnemonic -- a memorisation tool to help you remember that the syllables *wu*, *wo*, *ji*, *ti* [do not exist](../make-a-name#short-guidelines) in Toki Pona. It doesn't really mean anything by itself, other than calling your attention to those syllables.
...
In the end, none of those systems gained much popularity. We can easily express numbers [from 1 to 10](../25) with core words, and there are well-established ways to talk about [larger numbers](../large-numbers).
...
Toki Pona calques of English 'MLM' and 'WLW'. Can be easily expressed in full sentences, like in [lesson 26](../26).
