...
Wenn du eine fremde Sprache lernst, kann es natürlich sein, zu versuchen, die Wörter mit Wörtern zu verbinden, die du schon kennst. Deutschsprachige schauen sich oft Toki Pona an und denken, dass '󱤧 li' und 'ist' das gleiche bedeuten:
...
Auf Deutsch sind alle bedeutungsvollen Wörter entweder Nomen (wie '*Person*'), Adjektive (wie '*gut*'), und Verben (wie '*sehen*'). Es gibt auch andere Wortarten, aber wir können diese jetzt ignorieren.
