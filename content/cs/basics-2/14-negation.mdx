...
Právě jsme se naučili, jak někoho o něco požádat, ale jak někoho požádat, aby něco *nedělal\*a*? Je čas se naučit tvořit zápory pomocí **󱤂 ala**:
...
<List>
  ...
  <Word sl="suli ala" m="nevelký, nedůležitý" />
