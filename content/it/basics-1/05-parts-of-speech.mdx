...
In effetti, questo vale per _tutte_ le parole: se qualcosa è un sostantivo, un verbo o un aggettivo può diventare _qualunque dei tre_! Vediamo alcuni esempi tra le parole che abbiamo già appreso:
...
<List>
  ...
  <Word sl="suli" m="S: dimensione; V: ingrandire, enfatizzare; Agg: grande, impotante" />
  <Word sl="pona" m="S: bontà; V: migliorare; Agg: buono, piacevole" />
  <Word sl="waso" m="S: uccello; V: convertire in uccello; Agg: di un uccello, relativo agli uccelli, aviario" />
</List>
