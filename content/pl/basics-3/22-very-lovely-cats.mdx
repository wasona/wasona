...
<List>
  {/*<Word sl="pi" m="" />*/}
  <Word sl="jan pona" m="miła osoba" />
  <Word sl="jan lili" m="mała osoba" />
  <Word sl="pona lili" m="trochę miły" />
  <Word sl="jan pona lili" m="mała, miła osoba" />
  <Word sl="jan pi pona lili" m="trochę miła osoba" />
</List>

*'osoba miły mały'* kontra *'osoba (miły mały)'*.
...
Jednak w toki ponie rzeczowniki, czasowniki i przymiotniki mogą stać się inną częścią mowy. Więc odmiana i szyk wyrazów nie pomagają! Zamiast tego toki pona używa partkuły do zmiany sposobu analizy wyrażenia.
