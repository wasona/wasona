...
La mayoría de personas adaptan el nombre que ya usan. Suele ser solamente el nombre de pila; por ejemplo, el nombre de pila de [jan Sonja](https://tokipona.org/) es Sonja. A veces, es el nombre de pila + el apellido; el nombre de [jan Misali](https://www.youtube.com/@HBMmaster/) es Mitch Halley.
