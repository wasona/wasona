...
**&#xF19A6; su** se refiere al [tercer libro](/es/jan-sonja//) de jan Sonja después de **󱤪󱥕 lipu pu** y **󱤪󱦈 lipu ku**. Se publicó en 2024. Nuestras encuestas dicen que menos gente usa la palabra **&#xF19A6; su** en comparación con **󱥕 pu** y **󱦈 ku**. ¿Por qué? La causa exacta es difícil de definir, pero aquí hay algunas observaciones:
...
Me gusta este ejemplo de jan Sonja hablando [sobre una red WiFi](https://bsky.app/profile/tokipona.org/post/3lhti3v32ok2p). Es desconcertante que un electrodoméstico no pueda funcionar por si solo, aislado de *otros dispositivos*. **kulupu ilo** es una buena forma de decir exactamente todo lo que el lector necesita, y nada más.
