...
توکی‌پونا در طراحی‌اش سادگی و لذت‌بخش بودن را مد نظر داشته است. آواهای آن ساده است. حدود ۱۳۰ کلمه‌اش معنای گسترده و کلی دارند و هر کدام‌شان نکته‌ی جالبی در مورد خود دارند. دستورزبان آن هم از اساس ساده و در عین حال، در جای خود قدرتمند است.‏
