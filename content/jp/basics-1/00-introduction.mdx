...
トキポナ語は[様々な学ぶための資料](/jp/other-courses/)があり、Wasona はその一つにすぎません。Wasona の 3 章に分かれたコースでは、合計 30 コマの短いレッスンがあり、だんだん新しい単語や文法的な概念を学んでいける構造になっています。また、レッスンの後に、ミニゲームで語彙を練習でき、章末には、トキポナ語が利用されている場面（お話、会話、歌）がのっています。

Wasona では、読み書きを練習している間にトキポナ語の仕組みに慣れ、会話ができる程度に話せるようになります。ただし、<ruby>流暢<rt>りゅうちょう</rt></ruby>に話すことは数ヶ月（または数年）かかることなので、**このコースだけでペラペラになれるわけではありません**。

このコースを最大限活用するコツ
* 例文を発音してみましょう！
* ミニゲームで間違えてしまったとき、どこが間違っていたのかを自分の言葉で説明してみましょう。また、それを解説と照らし合わせてみましょう。
* もしなかなか分からないことがあった場合、[トキポナ語話者に実際にたずねる](https://discord.gg/ChC6qtVsSE)こともできます。
