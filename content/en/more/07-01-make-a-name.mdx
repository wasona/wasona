...
{/*
  Translators: this example is super America-centric.
  You are free to think of an example more relevant to your readers.
  Unfortunately you will lose the audio.
*/}
