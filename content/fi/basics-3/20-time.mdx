...
- title: "3. Lisää harjoituksia"
  ...
  - l1: "In my opinion, these clothes are nice."
    ...
    junkChips: ["o"]
  - l1: "Actually, other methods are possible."
...
**󱤡 la** can also be used between two sentences, joining them into one. The first sentence becomes a condition *'if or when ...'*, and the second becomes the result: *'then ...'*.
