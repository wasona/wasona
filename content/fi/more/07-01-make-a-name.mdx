---
slug: "fi/make-a-name"
title: "TODO:Kysymys: what's my name in Toki Pona?"
...
* For convenience, let's only use the Latin alphabet here. The [lesson on names](/fi/07/) shows everything you need for *sitelen pona*!
...
You might know the Vietnamese surname Nguyen, pronounced <Audio from="ipa" file="ŋwiəŋ" />. But in English, these sounds can't go in that order. So when English speakers say Nguyen, they adapt it to what English allows -- "win".
