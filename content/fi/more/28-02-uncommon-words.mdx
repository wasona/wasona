---
slug: "fi/uncommon-words"
title: "TODO:Kysymys: what other, uncommon words might I encounter?"
...
**&#xF19A6; su** refers to the [third book](/fi/jan-sonja/) by Sonja Lang after **󱤪󱥕 lipu pu** and **󱤪󱦈 lipu ku**. It was published in 2024. Our polling says fewer people use the word **&#xF19A6; su** than the words **󱥕 pu** and **󱦈 ku**. Why is that? The exact cause-and-effect is hard to trace, but here are some observations:
...
**wuwojiti** is a mnemonic -- a memorisation tool to help you remember that the syllables *wu*, *wo*, *ji*, *ti* [do not exist](/fi/make-a-name#short-guidelines) in Toki Pona. It doesn't really mean anything by itself, other than calling your attention to those syllables.
...
In the end, none of those systems gained much popularity. We can easily express numbers [from 1 to 10](/fi/25/) with core words, and there are well-established ways to talk about [larger numbers](/fi/large-numbers/).
...
Toki Pona calques of English 'MLM' and 'WLW'. Can be easily expressed in full sentences, like in [lesson 26](/fi/26/).
