...
The question and answer look exactly the same, except the answer appears in place of **󱥙 seme**. Everything else in the sentence stays in the same order! This is unlike English, where question words (wh-words) move themselves first in the sentence.
...
## Lue myös
* [Kysymys: how do you say 'to do'?](/fi/doing/)
