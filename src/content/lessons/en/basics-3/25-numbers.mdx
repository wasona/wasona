...
Let's talk numbers! Toki Pona only has a few number words, but they are enough for counting:
...
Yes, that's right: Toki Pona has words for 1, 2, 5, but not 3 or 4! But this is not so strange, is it? You've all seen coins, which also work this way. Let's try counting from 1 to 10:
...
By convention, we like to list the largest number first, and use the "fewest coins".
...
## See also
* [Q: how do I talk about large numbers?](en/more/large-numbers/)
