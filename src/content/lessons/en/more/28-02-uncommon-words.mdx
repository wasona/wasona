...
It's a tempting, simple model, but I don't think it solves the complexity, it just hides it. **󱥾 tonsi** is widely used, but was created in 2019. **󱤹 mu** appears in the 2014 book, but it mostly exists to be funny. **mulapisu** is almost unknown, but was made by jan Sonja. Which of them are **nimisin**? None of them? All of them? Nobody knows, because the word isn't meant to be clear.
