...
<List>
  <Word sp="&#xF199E;" sl="te" m="opens a quote" />
  <Word sp="&#xF199F;" sl="to" m="closes a quote" />
</List>
...
<List>
  <Word sp=" " sl="yupekosi" m="to behave like George Lucas and revise your old creative works and actually make them worse" />
  <Word sp=" " sl="mulapisu" m="pizza" />
  <Word sp=" " sl="sutopatikuna" m="platypus" />
</List>
...
These words exist *in the context* of these three approaches to Toki Pona. **mulapisu** and **yupekosi** were created by jan Sonja in 2019, in a then-rare visit to [ma pona](https://discord.gg/6zkugJFU4x). They subvert the idea of *authorial intent*: look, the creator can still make something that doesn't suit the language!

jan Sonja coined **kijetesantakalu** for April Fools 2009, the joke being that the word is much too long and much too specific for Toki Pona. **sutopatikuna** comes from a response to that post, a community member making essentially the same joke. Comparing the two words, you can see how authorial intent still matters: **kijetesantakalu** ended up becoming a popular community mascot, while **sutopatikuna** is a rarely-relevant joke.

You can also notice a distinction between proficient Toki Pona speakers, and merely those who are learning or interested: **sutopatikuna**, made by a community member, breaks a basic Toki Pona of avoiding the syllable *ti*. Does that make the joke better or worse? You decide.
...
<List>
  <Word sp=" " sl="san" m="three" />
  <Word sp=" " sl="po" m="four" />
</List>
