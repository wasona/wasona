...
In 2021, jan Kapilu and jan Tepo came up with a [expanded and backward-compatible system](https://sona.pona.la/wiki/nasin_nanpa_pona) to talk about large numbers: instead of adding 100, **󱤄 ale** multiplies the previous number by 100.
