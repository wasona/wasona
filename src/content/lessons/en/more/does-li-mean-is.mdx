...
In English, all meaningful words are divided into nouns (like '*bird*'), adjectives (like '*good*'), and verbs (like '*eat*'). There are other parts of speech too, but we can ignore them now.
