...
richDescription: "Learn 󱤇 anu, 󱥙 seme!"
practice:
  ...
  - l1: "What is there in Japan?"
    l2: "seme li lon ma Nijon?"
...
English has a special word for 'yes'. Toki Pona instead does what many other languages [which ones?] do: you reply with the verb for 'yes', and a verb + **󱤂 ala** for 'no'.
...
Some **󱥙 seme** questions can be very broad:

<List>
  <Sentence sl="sina seme?" m="What are you? What are you doing?" />
  <Sentence sl="mi jan Mili." m="I am Millie." />
  <Sentence sl="mi pona e ilo kalama." m="I fix the radio." />
</List>
